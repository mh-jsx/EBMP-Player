...
import com.emot.emotionPlayer.dataloaders.AlbumLoader;
import com.emot.emotionPlayer.dataloaders.AlbumSongLoader;
import com.emot.emotionPlayer.dataloaders.ArtistAlbumLoader;
import com.emot.emotionPlayer.dataloaders.ArtistLoader;
import com.emot.emotionPlayer.dataloaders.ArtistSongLoader;
import com.emot.emotionPlayer.dataloaders.PlaylistLoader;
import com.emot.emotionPlayer.dataloaders.PlaylistSongLoader;
import com.emot.emotionPlayer.dataloaders.SongLoader;
import com.emot.emotionPlayer.models.Album;
import com.emot.emotionPlayer.models.Artist;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "naman14.emotionPlayer/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "naman14.emotionPlayer/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "naman14.emotionPlayer/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "naman14.emotionPlayer/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
