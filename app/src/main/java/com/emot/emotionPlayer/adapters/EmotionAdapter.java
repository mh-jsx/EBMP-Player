package com.emot.emotionPlayer.adapters;
...
public class EmotionAdapter extends RecyclerView.Adapter<EmotionAdapter.ItemHolder> {
    ...
    public EmotionAdapter(Activity context, List<Playlist> arraylist) {
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            NavigationUtils.navigateToPlaylistDetail(mContext, Constants.NAVIGATE_PLAYLIST_USERCREATED, (long) albumArt.getTag(), String.valueOf(title.getText()), foregroundColor, arraylist.get(getAdapterPosition()).id, null);
