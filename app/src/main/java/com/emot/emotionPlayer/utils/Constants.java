...
public class Constants {
    ...
    public static final String NAVIGATE_EMOTION = "navigate_emotion";
    ...
    public static final int EMOTION_VIEW_DEFAULT = 0;
    public static final int EMOTION_VIEW_LIST = 1;
    public static final int EMOTION_VIEW_GRID = 2;
