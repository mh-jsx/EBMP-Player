...
public class emotApp extends MultiDexApplication {


    private static emotApp mInstance;

    public static synchronized emotApp getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration localImageLoaderConfiguration = new ImageLoaderConfiguration.Builder(this).imageDownloader(new BaseImageDownloader(this) {
            PreferencesUtility prefs = PreferencesUtility.getInstance(emotApp.this);
