...
import com.emot.emotionPlayer.adapters.SongsListAdapter;
import com.emot.emotionPlayer.dataloaders.LastAddedLoader;
...
import com.emot.emotionPlayer.dataloaders.TopTracksLoader;
...
import com.emot.emotionPlayer.widgets.DragSortRecycler;
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_delete_playlist:
                ...
                if(name.equals("Happy")||name.equals("Sad")||name.equals("Neutral")){

                    Toast.makeText(this, "Playlist "+name+" cannot be deleted",
